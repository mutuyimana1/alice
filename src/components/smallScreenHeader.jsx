  ...
  return (
    <div className='homeContainer '>
        <div className='pt-32 relative h-full'>
            <h1 className='text-black absolute top-[45%] left-[20%] text-[40px] uppercase font-bold'>Rene</h1>
            <img src={homeImage} alt="" className='wd-[40redm]  absolute sm:-top-[10px] sm:left-3'/>
