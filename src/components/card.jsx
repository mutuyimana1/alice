...
const Card=(props)=>{
    return(
        <>
        <div className="flex xl:w-[350px] 2xl:w-[430px] mb-5 lg:mb-0 md:h-[200px] xl:h-[250px] 2xl:h-[292px] border-[.2px] border-[#cdcdcd42]  rounded-lg" onClick={props.onClick} >
            <div className="w-[50%] h-full rounded-lg">
                <img src={props.image} style={{height:"100%",borderRadius:"10px 0px 0px 10px"}} />

            </div>
            <div className="w-[49%] h-full bg-white rounded-slg" style={{borderRadius:"0px 10px 10px 0px"}}>
